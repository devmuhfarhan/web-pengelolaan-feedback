...
Bersedia kembali: ${formData.q5_bersedia}
  ...
  if (isBeneficiary) {
    ...
    return (
      <div className="max-w-3xl mx-auto pb-12 animate-in fade-in duration-500 font-sans">
        <div className="text-center mb-8">
          <h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white mb-2">Your Voice Matters</h1>
          <p className="text-slate-500 text-sm max-w-lg mx-auto">We value your feedback to improve our programs. Please share your experience with the NGO initiatives you are part of.</p>
        </div>
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col gap-1 mb-6">
        <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Feedback Log</h1>
        <p className="text-slate-500 text-sm">Review and manage beneficiary feedback reports.</p>
      </div>
